				...
				<div class="audit-parameters-row audit-parameters-row-title">
					<div class="audit-parameters-succes numb-box">
						<div class="audit-parameters-succes-numb count">
							<?=$arResult["ITEMS"][0]["SUSSES"]?><sup>/<?=$arResult["ITEMS"][0]["SUM_TOTAL"]?></sup>
						</div>
					...
					<div class="audit-parameters-warning">
						<div class="audit-parameters-succes-numb count">
							<?=$arResult["ITEMS"][0]["MIDDLE"]?><sup>/<?=$arResult["ITEMS"][0]["SUM_TOTAL"]?></sup>
						</div>
						<div class="audit-parameters-succes-info info">
							Предупреждений
						</div>
					...
					<div class="audit-parameters-error">
						<div class="audit-parameters-succes-numb count">
							<?=$arResult["ITEMS"][0]["FAIL"]?><sup>/<?=$arResult["ITEMS"][0]["SUM_TOTAL"]?></sup>
						</div>
						<div class="audit-parameters-succes-info info">
							Ошибок
						</div>
	...
	<td>
		<div class="footer-inner">
			<div class="footer-date">
				Экспресс-аудит сайта <?=$arResult['NAME']?>, 21.05.2021
			</div>
		</div>
	</td>
</tr>
